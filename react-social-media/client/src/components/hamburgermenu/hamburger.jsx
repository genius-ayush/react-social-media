                    ...
                    <div className='links'>
                        <div className='item linkitem'>
                            <a className='link' href='/messages'>
                                <Chat className='leftbar-icon' style={{'height': '40px','width':'40px', 'color':'#0e6efc','marginRight':'30px'}} />
                                <span className="menu-item" href="/messages">Messenger</span>
                            </a>
                        </div>
                        <div className='item linkitem'>
                            <a className='link' href={`/profile/${currentUser?._id}`}>
                                <Person className='leftbar-icon' style={{'height': '40px','width':'40px', 'color':'#0e6efc', 'marginRight':'30px'}} />
