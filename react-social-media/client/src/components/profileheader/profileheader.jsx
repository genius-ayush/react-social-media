...
=======
                    <label  style={currentUser._id === id ? {cursor:'pointer'} : {cursor:'default'}} htmlFor={currentUser._id === id ? 'cover' : ''}>{/*label needs to inherit the classname so it keeps same formatting  */}
>>>>>>> 3078e5d059c6282aa56709c951cad6c7f33d2bea
